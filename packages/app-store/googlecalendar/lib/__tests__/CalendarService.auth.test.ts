...
describe("GoogleCalendarService retry configuration", () => {
  // TEMPORARY PATCH TEST — see issue calcom/cal.com#28834 and PR calcom/cal.com#29599.
  // Remove alongside the retryConfig in CalendarAuth.ts when reverting to the official image.
